        ...
        <footer className="footer">
          ...
          <div className="footer-section company">
            ...
            <ul>
              ...
              <li><a href="/terms" title="Terms and Conditions"><HoverLink text="Terms of Service"/> </a></li>
              <li><a href="/policyprivacy" title="Privacy Policy"><HoverLink text="Privacy policy"/> </a></li>
            </ul>
          </div>
          </footer>
        </div>
